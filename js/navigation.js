(function () {
  ...
  var defaultDescription = "Club de MMA au Rove pour enfants, ados et adultes. Cours d'essai offerts à la Salle Jennifer, proche Côte Bleue, lundi et mercredi.";
  ...
  var shopTitle = "Tenue officielle | Mix Martial Academy Le Rove";
  var shopDescription = "Commande groupée de la tenue officielle Mix Martial Academy — Le Rove.";

  function updateMetadata(view) {
    var isMedical = view === "documents-medicaux";
    var isLeague = view === "regles-mma-league";
    var isShop = view === "boutique";
    var description = document.querySelector('meta[name="description"]');
    var canonical = document.querySelector('link[rel="canonical"]');
    document.title = isMedical ? medicalTitle : (isLeague ? leagueTitle : (isShop ? shopTitle : defaultTitle));
    if (description) description.setAttribute("content", isMedical ? medicalDescription : (isLeague ? leagueDescription : (isShop ? shopDescription : defaultDescription)));
    if (canonical) canonical.setAttribute("href", isMedical ? "https://www.mma-lerove.fr/#documents-medicaux" : (isLeague ? "https://www.mma-lerove.fr/#regles-mma-league" : (isShop ? "https://www.mma-lerove.fr/#boutique" : "https://www.mma-lerove.fr/")));
  }
